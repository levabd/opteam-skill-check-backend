    ...
    <div class="col-lg-8 m-auto">
      <card :title="$t('register')">
        <form @submit.prevent="register" @keydown="form.onKeydown($event)">
          ...
          <div class="row" v-if="facebookIsAvailable || linkedinIsAvailable">
            <div class="col-md-7 offset-md-3 d-flex">
              <p>{{ $t('or') }}</p>
            </div>
          </div>
          <div class="form-group row" v-if="facebookIsAvailable">
            <div class="col-md-7 offset-md-3 d-flex">
              <linkedin-social-button title="register_with"/>
            </div>
          </div>

          <div class="form-group row" v-if="linkedinIsAvailable">
            <div class="col-md-7 offset-md-3 d-flex">
              <facebook-social-button title="register_with"/>
            </div>
          </div>
        </form>
      </card>
...
import LinkedinSocialButton from '~/components/LinkedinSocialButton'
...
export default {
  ...
  computed: {
    ...
    linkedinIsAvailable(){
      return window.config.linkedinAuth
    },
  },
  metaInfo () {
